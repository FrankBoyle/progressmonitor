                ...
                itemsHtml += `
                    <div class="item" data-id="${item.id}">
                        ...
                        <div class="toggle-button">
                            ...
                            <label for="first${item.id}" class="toggle-label"><i class="far fa-square"></i> 1st Place</label>
                        </div>
                        <div class="toggle-button">
                            <input type="radio" id="second${item.id}" name="second" value="${item.id}" hidden>
                            <label for="second${item.id}" class="toggle-label"><i class="far fa-square"></i> 2nd Place</label>
                        </div>
                        <div class="toggle-button">
                            <input type="radio" id="third${item.id}" name="third" value="${item.id}" hidden>
                            <label for="third${item.id}" class="toggle-label"><i class="far fa-square"></i> 3rd Place</label>
                        </div>
                    </div>
                `;
            });
