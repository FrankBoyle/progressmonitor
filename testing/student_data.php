        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><?php echo htmlspecialchars($studentName); ?> Performance Data - <?php echo htmlspecialchars($selectedCategoryName); ?></h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <?php foreach ($metadataEntries as $metadataEntry): ?>
                            <a href="?student_id=<?php echo htmlspecialchars($studentId); ?>&metadata_id=<?php echo htmlspecialchars($metadataEntry['metadata_id']); ?>">
                                <?php echo htmlspecialchars($metadataEntry['category_name']); ?>
                            </a><br>
                        <?php endforeach; ?>
                    </div>
                                        ...
                                        <tr data-performance-id="<?php echo htmlspecialchars($data['performance_id']); ?>">
                                            ...
                                            <?php for ($i = 1; $i <= 10; $i++): ?>
                                                <td class="editable" data-field-name="score<?php echo $i; ?>">
                                                    <?php echo isset($data['score'.$i]) ? htmlspecialchars($data['score'.$i]) : ""; ?>
                                                </td>
                                            <?php endfor; ?>
                                            <td><button class="deleteRow btn btn-primary" data-performance-id="<?php echo htmlspecialchars($data['performance_id']); ?>">Delete</button></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tbody>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="info-box">
                                        <div class="info-box-content goal-container">
                                            ...
                                            <label class="goal-checkbox-label">
                                                <input type="checkbox" class="goal-checkbox" data-goal-id="<?php echo htmlspecialchars($goal['goal_id']); ?>">
                                                Select
                                            </label>
                                            <textarea id="summernote<?php echo $index + 1; ?>" class="goaltext" contenteditable="true" data-goal-id="<?php echo htmlspecialchars($goal['goal_id']); ?>">
                                                <?php echo htmlspecialchars($goal['goal_description']); ?>
                                            </textarea>
                                            <button class="save-goal-btn" data-goal-id="<?php echo htmlspecialchars($goal['goal_id']); ?>">✔</button>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        ...
                        <div class="add-goal-form">
                            ...
                            <button id="addNewGoalBtn" class="btn btn-primary">Add New Goal</button>
                        </div>
